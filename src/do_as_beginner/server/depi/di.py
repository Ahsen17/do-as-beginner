...
class Container:
    ...
    def _consumer_target(self, spec: ParamSpec) -> Registration | None:
    ...
    def _provider_target(self, spec: ParamSpec, owner: str) -> Registration | None:
...
def _introspect_params(callable_: Any) -> list[ParamSpec]:
